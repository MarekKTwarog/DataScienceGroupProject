...
liver_dfcleanPW_IMP <- na.omit(liver_dfcleanPW_IMP)
...
#Remove NA values from liver_dfcleanPW_IMP dataframe
liver_dfcleanGLM_IMP <- na.omit(liver_dfcleanGLM_IMP)
...
################################################################################
################ REMOVING REMAINING NA's FROM DATAFRAMES #######################
################################################################################

#'The final set requires the removal of NA values from the imputed dataset, this 
#'is done using the na.omit function
